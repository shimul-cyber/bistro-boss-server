...
const uri = `mongodb+srv://${process.env.DB_BISTRO_BOSS_USER}:${process.env.DB_BISTRO_BOSS_PASS}@cluster0.nuxvx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
